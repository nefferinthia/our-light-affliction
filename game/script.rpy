...
label postchoice_ilyameeting:
    ...
    "His voice void of its usual levity. I swallow nervously."
...
label endings:
    ...
    menu:
        ...
        "Lucifrid#" if true_ending >= 1:
            ...
            "The hard part comes in upholding them when there's no one around to be impressed with them."
